...
2. Also read these project files: `PROJECT.md`, `PHASES.md`, `DECISIONS.md`, `CONSTITUTION.md`, `project_guidelines.md`, `tempire_workflow.md`
...
5. Only load relevant skills from `.agent/skills/` and `.agent/.agent/skills/`
